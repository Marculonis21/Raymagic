...
namespace Raymagic
{
    public class Showcase
    {
        public Showcase()
        {
            ...
            /* /1* Door door1 = new Door(testChamberCenterPoint[1] - new Vector3(-30,-30,100), new Vector3(1,0,0), Color.Azure); *1/ */
            /* /1* Door door2 = new Door(testChamberCenterPoint[1] - new Vector3(  0,  0,100), new Vector3(1,0,0), Color.Blue); *1/ */
            /* /1* Door door3 = new Door(testChamberCenterPoint[1] - new Vector3( 30, 30,100), new Vector3(1,0,0), Color.Violet); *1/ */

            /* /1* data.interactableObjectList.Add(door1); *1/ */
            /* /1* data.interactableObjectList.Add(door2); *1/ */
            /* /1* data.interactableObjectList.Add(door3); *1/ */
